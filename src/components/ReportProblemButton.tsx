  ...
  return (
    <>
      <button
        type="button"
        onClick={openModal}
        className="inline-flex items-center gap-2 self-start rounded border border-[#a8380c] bg-[#a8380c] px-4 py-2 text-sm font-medium text-white transition-colors hover:border-[#8c2f0a] hover:bg-[#8c2f0a]"
      >
        Report a problem
      </button>
